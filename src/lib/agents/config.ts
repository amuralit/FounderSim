...
export const AGENTS: AgentDef[] = [
  ...
  { id: 'developer', name: 'Pixel', role: 'Builder', color: '#10b981',
    ...
    defaultPosition: { x: 84, y: 75 } },
];

// Non-overlapping grid layout with proper gaps
export const ZONES = [
  { id: 'research-lab', label: 'Research',      x: 1.5,  y: 2,   w: 31, h: 38 },
  { id: 'ceo-office',   label: 'Strategy',      x: 34.5, y: 2,   w: 31, h: 38 },
  { id: 'war-room',     label: 'Product',       x: 67.5, y: 2,   w: 31, h: 38 },
  { id: 'deploy-zone',  label: 'Deploy',        x: 1.5,  y: 43,  w: 31, h: 38 },
  { id: 'architecture', label: 'Architecture',  x: 34.5, y: 43,  w: 31, h: 38 },
  { id: 'dev-bay',      label: 'Development',   x: 67.5, y: 43,  w: 31, h: 38 },
];
