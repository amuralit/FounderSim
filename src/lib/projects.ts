...
export function createNewProject(): Project {
  return {
    ...
    chatHistories: {},
    decisions: [],
    statuses: { ceo: 'idle', research: 'idle', product: 'idle', architect: 'idle', developer: 'idle' },
    demoUrl: null,
    webUrl: null,
    logoBase64: null,
...
export function migrateOldState(): Project | null {
  try {
    ...
    const project: Project = {
      ...
      statuses: s.statuses || { ceo: 'idle', research: 'idle', product: 'idle', architect: 'idle', developer: 'idle' },
